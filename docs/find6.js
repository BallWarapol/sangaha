...
coolfind.create_find_div = function()
{
	...
	var button_style = "display: inline-block;  min-height: 1.15em; min-width: 1.5em; max-width: 12em; vertical-align: middle; text-align: center; font-size: 1em;"+ // Version 6.0b - Added font-size: 1em; for "button" element to display properly
	...
	*/
	...
	coolfind.find_button_html = "Search? Click Here!";
